		...
		<div class="content-header row">
				...
				<div class="content-header-right col-md-6 col-12">
			        <div class="dropdown float-md-right">
				        <a href="{{route('albums.create')}}"  class="btn btn-primary float-right mt-2">Add albums</a>
				    </div>
				</div>
										...
										<tbody>
											@foreach ($albums as $_item)
												<tr>
																			...
																			<td>
																				<a href="{{url('album',$_item->id)}}"  >{{$_item->name}}</a>
																			</td>
																		                  ...
																		                  @foreach ($_item->images as $key =>$image)
																			                  @if($key==0)
																				                  <div class="carousel-item active">
																				                    <img src="{{asset('images/'.$image->title) }}" alt="First slide"  height="350px" width="450">
																				                  </div>
																			                  @else
																			                   	<div class="carousel-item ">
																				                   	<img src="{{asset('images/'.$image->title) }}" alt="Second slide"  height="350px" width="450">
																			                    </div>
																			                    @endif
																		                  @endforeach
																		                </div>
						...
						<div class="modal-body">
							<div class="form-content p-2">
								...
								<div class="row text-center">
									...
									<div class="col-sm-2">
										<form method="post" action="{{route('albums.destroy','test')}}">
	                                   		 @csrf
	                                         @method('delete')
